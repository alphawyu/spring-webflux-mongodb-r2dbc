...
import com.realworld.springmongo.persistence.repository.ArticleRepository
import com.realworld.springmongo.persistence.repository.TagRepository
...
class ArticleApiTest(
    ...
    fun `should create article`() {
        ...
        assertThat(savedArticle.map(ArticleEntity::title))
            .hasSize(1)
    ...
    fun `should return feed`() {
        ...
        articleApi.createArticle(author = followingUser, createRequest = ArticleSamples.sampleCreateArticleRequest("1"))
        articleApi.createArticle(author = followingUser, createRequest = ArticleSamples.sampleCreateArticleRequest("2"))
        articleApi.createArticle(author = followingUser, createRequest = ArticleSamples.sampleCreateArticleRequest("3"))
        articleApi.createArticle(author = follower, createRequest = ArticleSamples.sampleCreateArticleRequest("4"))
    ...
    fun `should find articles`() {
        ...
        val article1 = articleApi.createArticle(ArticleSamples.sampleCreateArticleRequest("1")
            .copy(tagList = listOf(expectedTag)),
            author = user1
        )
        val article2 = articleApi.createArticle(ArticleSamples.sampleCreateArticleRequest("2")
            .copy(tagList = listOf(expectedTag)),
            author = user2
        )
        articleApi.createArticle(author = user2, createRequest = ArticleSamples.sampleCreateArticleRequest("3"))
    ...
    fun `should get tags`() {
        val user = userApi.signup()
        articleApi.createArticle(ArticleSamples.sampleCreateArticleRequest("1")
            .copy(tagList = listOf("tag1", "tag2", "tag2")),
            author = user)
        articleApi.createArticle(ArticleSamples.sampleCreateArticleRequest("2")
